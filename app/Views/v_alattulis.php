...
<div class="container mt-5">
    ...
    <?php endif; ?>
    <div class="row mt-3">
    <a href="/barang/create/" class="btn btn-primary mb-3 btn-create">Create</a>
        <div class="col">
    ...
    function confirmDelete() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                // Jika pengguna mengonfirmasi, maka arahkan ke link delete
                window.location.href = "/barang/delete/<?= $brg['Kode']; ?>";
            }
        });
        // Kembalikan false agar link tidak diikuti
        return false;
    }
</script>
