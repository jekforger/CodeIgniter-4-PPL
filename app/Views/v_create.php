...
<head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-wLFha2sRZDwfBSvQzI amVHjkvyl/ATFDxoC2t1VhQvDkBhwPcMkUybQzLMTs/jA" crossorigin="anonymous">
...
<div class="container">
  ...
  <form action="/barang/store" method="post" enctype="multipart/form-data"> <?= csrf_field() ?>

    <table class="form-table">
      <tr>
        <th><label for="Kode" class="form-label">Kode</label></th>
        <td><input type="text" class="form-control" id="Kode" name="Kode" value="<?= old('Kode') ?>"></td>
      </tr>
      <tr>
        <th><label for="Nama_Barang" class="form-label">Nama Barang</label></th>
        <td><input type="text" class="form-control" id="Nama_Barang" name="Nama_Barang" value="<?= old('Nama_Barang') ?>"></td>
      </tr>
      <tr>
        <th><label for="Harga" class="form-label">Harga</label></th>
    ...
    <div class="text-center mt-4 button-margin">
      <button type="submit" class="custom-saveButton">Simpan</button>
    </div>
  </form>
</div>
